...
# Placeholder para colocar o botão de download FORA do form (logo abaixo)
...
# Opcional: botão para recapturar (força rerun)
...
with st.form("checklist_form"):
    ...
    if enviar:
        ...
        # Guarda os bytes no session_state para o botão fora do form
        if pdf_bytes:
